...
#define NO_PUBLIC_KEY_NEEDED
 /* see http://libssh2.org/libssh2_userauth_publickey_fromfile_ex.html
  * arguments of libssh2_userauth_publickey_fromfile
  ...
  * Since this is the case, the publickey can be omitted.
  * That would solve the issue of having to convert the public key to openssh
  * format if it was generated by PuTTY Key Generator.
  */
